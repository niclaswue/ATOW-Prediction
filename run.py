...
from evals.simple import SimpleEvals
from evals.compare_models import plot_metric_overview
...
def main():
    ...
    for model in MODELS:
        ...
        for evaluator in EVALS:
            ...
            model_results[model.name] = evaluation
            for k, v in evaluation.items():
                print(f"{k:<20}: {v:.3f}")
            print("-" * 10)

    plot_metric_overview(model_results)
